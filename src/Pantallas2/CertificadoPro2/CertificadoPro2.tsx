...
export default function CertificadoPro2({ navigation }: Props) {
  return (
    <ContainerScroll>
      <Container>
        <BarraIconos
          titulo={"2/5 Validación profesional"}
          margin={"0px"}
        ...
        <TituloView>
          ...
          >
            Para obtener tu validación TopLive necesita tu información académica
            Llena los campos para poder ofrecer tus asesorías en la plataforma
          </StyledText>
        </TituloView>
        <InfoView>
          <StyledText
          ...
          <InfoPersonal titulo={"Titulo"} icon={"chevron-right"} />
          <InfoPersonal titulo={"Tipo de certificado"} icon={"chevron-right"} />
          <InfoPersonal titulo={"Establecimiento"} />
          <InfoPersonal titulo={"Año de adquisición"} />
          <AgregarView>
            <StyledText
              size={12}
              weight={400}
          ...
          <InfoPersonal titulo={"Titulo"} icon={"expand-more"} />
          <InfoPersonal titulo={"Tipo de certificado"} icon={"expand-more"} />
          <InfoPersonal titulo={"Establecimiento"} />
          <InfoPersonal titulo={"Año de adquisición"} />
          <AgregarView>
            <StyledText
