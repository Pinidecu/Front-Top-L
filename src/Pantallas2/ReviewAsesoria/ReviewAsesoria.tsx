...
export default function ReviewAsesoria({ navigation }: Props) {
  return (
    <ContainerScroll>
      <Container>
        <BarraIconos
        ...
        <InfoView>
          <Calificacion
            titulo={"Calidad de la asesoría recibida"}
            estrellas={4}
            comentario={"Buena calidad!"}
            linea={true}
          />
          <Calificacion
            titulo={"El profesional resolvió mis dudas"}
            estrellas={0}
            linea={true}
          />
          <Calificacion
          ...
          />
          <Calificacion
            titulo={"El profesional fue amable y cordial"}
            estrellas={0}
            linea={true}
          />
          <Calificacion
            titulo={"Dominio del tema del profesional"}
            estrellas={0}
          />
          <DescripcionView>
            <StyledText
