...
export default function CertificadoPro3({ navigation }: Props) {
  return (
    <ContainerScroll>
      <Container>
        <BarraIconos
          titulo={"3/5 Validación profesional"}
          margin={"0px"}
        ...
        <TituloView>
          ...
          >
            En toplive podrás agregar diferentes áreas de expeticia y sus
            diferentes especializaciones. Incluye todas las áreas en las cuales
            tengas certificación o estudios superiores.
          </StyledText>
        </TituloView>
        <InfoView>
          <AsesoriaView>
          ...
          <InfoPersonal titulo={"Diseño"} icon={"chevron-right"} />
          <InfoPersonal titulo={"Diseño Web"} icon={"chevron-right"} />
          <InfoPersonal titulo={"Años de experiencia"} />
          <InfoPersonal titulo={"Certificado de conocimiento"} icon={"add"} />
          <InfoPersonal
            titulo={"Duración de la asesoría"}
            icon={"chevron-right"}
          />
          <InfoPersonal
            titulo={"Precio de la asesoría"}
            icon={"chevron-right"}
          />
          <InfoPersonal
            titulo={"Paquetes de asesorías"}
            icon={"chevron-right"}
          />
          <AgregarView>
            <StyledText
