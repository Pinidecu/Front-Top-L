    ...
    <ContainerScroll>
      <Container>
        ...
        <ViewHistorial>
          ...
          <Historial nombre="Asesorías creadas" />
          <Historial nombre="Lista de clientes" />
          <Historial nombre="Eventos creados" />
        </ViewHistorial>
        <ViewHistorial>
          <StyledText
            size={14}
          ...
          <Historial nombre="Asesorías recibidas" />
          <Historial nombre="Eventos asistidos" />
          <Historial nombre="Reviews" />
          <Historial nombre="Denuncias" />
        </ViewHistorial>
      </Container>
    </ContainerScroll>
  );
